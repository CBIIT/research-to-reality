	...
	<div class="container">
		<div class="row">
			...
			<section class="welcome-container">
				<div class="welcome">
					<?php if (!empty($page['R2R_Intro'])): ?>
          				<?php print render($page['R2R_Intro']); ?>
        			<?php endif; ?>
				</div> 
			</section>
...
</section> <!-- close homepage-intro -->

<!-- Stats -->
<section class="stats hidden-xs">
	<div class="container">
		<div class="row">
			<div class="col-sm-4 text-center">
				<?php if (!empty($page['R2R_Stats_Members'])): ?>
          			<?php print render($page['R2R_Stats_Members']); ?>
        		<?php endif; ?>
			</div> <!-- close col-md-4 -->
			<div class="col-sm-4 text-center">
				<?php if (!empty($page['R2R_Stats_Discussions'])): ?>
          			<?php print render($page['R2R_Stats_Discussions']); ?>
        		<?php endif; ?>
			</div> <!-- close col-md-4 -->
			<div class="col-sm-4 text-center">
				<?php if (!empty($page['R2R_Stats_Events'])): ?>
          			<?php print render($page['R2R_Stats_Events']); ?>
        		<?php endif; ?>
			</div> <!-- close col-md-4 -->
		</div> <!-- close row -->
	</div> <!-- close container -->
